...
parser.add_option('-u', '--url', action="store", dest="url",
                  help="URL Endpoint for Docker Registry API v2. Eg https://IP:Port", default="spam")
        ...
        if target_repo in list_of_repos:
            ...
            if tags is not None:
                ...
                if target_tag in tags:
                    ...
                    print(dir_cur)
                    if '/' in target_repo:
                        temp_l = target_repo.split('/')
                        temp_dir = ''
                        for i in temp_l:
                            temp_dir = temp_dir + '_' + i
                    ...
                    for x in final_list_of_blobs:
                        print("\n[+] Downloading Blob: "+x)
                        download_blobs(target_repo, x, dir)
                else:
